    ...
    ($fn_name:ident, $word:tt, $key_words:tt, $alpha:literal, $beta:literal, $rounds:expr) => {
        ...
        pub fn $fn_name(ct: [__m128i; 2], key: [__m128i; $key_words]) -> [__m128i; 2] {
            ...
            seq_macro::seq!(I in 0..=$rounds {
                $crate::sse2_encrypt_round_inline!(x, y, round_keys[I], $word, $alpha, $beta);
            });
...
macro_rules! impl_encrypt_block_sse2_inflight {
    ($fn_name:ident, $word:tt, $key_words:tt, $alpha:literal, $beta:literal, $rounds:expr) => {
        ...
        pub fn $fn_name(ct: [__m128i; 2], key: [__m128i; $key_words]) -> [__m128i; 2] {
            ...
            seq_macro::seq!(I in 0..$rounds {
                $crate::sse2_encrypt_round_inline!(x, y, k, $word, $alpha, $beta);
                $crate::sse2_encrypt_round_inline!(l[$crate::key_idx!($key_words, I)],
                    k, $crate::sse2_set!($word, I), $word, $alpha, $beta);
            });
            $crate::sse2_encrypt_round_inline!(x, y, k, $word, $alpha, $beta);
