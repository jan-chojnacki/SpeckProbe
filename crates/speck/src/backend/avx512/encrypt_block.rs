...
macro_rules! impl_encrypt_block_avx512 {
    ($fn_name:ident, $feature:literal, $word:tt, $key_words:tt, $alpha:literal, $beta:literal, $rounds:expr) => {
        ...
        pub fn $fn_name(ct: [__m512i; 2], key: [__m512i; $key_words]) -> [__m512i; 2] {
            ...
            $crate::avx512_expand_key_inline!(round_keys, key, $word, $key_words, $alpha, $beta, $rounds);

            let mut x = ct[0];
            let mut y = ct[1];

            seq_macro::seq!(I in 0..=$rounds {
                $crate::avx512_encrypt_round_inline!(x, y, round_keys[I], $word, $alpha, $beta);
            });
...
macro_rules! impl_encrypt_block_avx512_inflight {
    ($fn_name:ident, $feature:literal, $word:tt, $key_words:tt, $alpha:literal, $beta:literal, $rounds:expr) => {
        ...
        pub fn $fn_name(ct: [__m512i; 2], key: [__m512i; $key_words]) -> [__m512i; 2] {
            ...
            seq_macro::seq!(I in 0..$rounds {
                $crate::avx512_encrypt_round_inline!(x, y, k, $word, $alpha, $beta);
                $crate::avx512_encrypt_round_inline!(l[$crate::key_idx!($key_words, I)],
                    k, $crate::avx512_set!($word, I), $word, $alpha, $beta);
            });
            $crate::avx512_encrypt_round_inline!(x, y, k, $word, $alpha, $beta);
