    ...
    ($block:literal, $key:literal, $word:literal, $key_words:literal) => {
        paste! {
            ...
            pub fn [<neon_encrypt_block_ $block _ $key>](ct: [neon_word_ty!($word); 2], key: [neon_word_ty!($word); $key_words]) -> [neon_word_ty!($word); 2] {
                ...
                for k in round_keys {
                    [<neon_encrypt_round_ $word>](&mut x, &mut y, k);
                }
...
impl_encrypt_block_neon!(32, 64, 16, 4);
impl_encrypt_block_neon!(48, 72, 24, 3);
impl_encrypt_block_neon!(48, 96, 24, 4);
impl_encrypt_block_neon!(64, 96, 32, 3);
impl_encrypt_block_neon!(64, 128, 32, 4);
impl_encrypt_block_neon!(96, 96, 48, 2);
impl_encrypt_block_neon!(96, 144, 48, 3);
impl_encrypt_block_neon!(128, 128, 64, 2);
impl_encrypt_block_neon!(128, 192, 64, 3);
impl_encrypt_block_neon!(128, 256, 64, 4);
