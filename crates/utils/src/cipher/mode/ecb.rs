...
impl SPECK {
    fn speck_ecb_encrypt<W: Copy, const WORD_BYTES: usize, const KEY_WORDS: usize>(
        &self,
        data: &[u8],
    ...
    fn speck_ecb_decrypt<W: Copy, const WORD_BYTES: usize, const KEY_WORDS: usize>(
        &self,
        data: &[u8],
        block_cipher: fn([W; 2], [W; KEY_WORDS]) -> [W; 2],
        read_word: fn(&[u8]) -> W,
    ...
    pub(in crate::cipher) fn encrypt_ecb(&self, data: &[u8]) -> Result<Vec<u8>, SPECKError> {
        let out = match self.speck_version {
            SpeckVersion::Speck32_64 => self.speck_ecb_encrypt::<u16, 2, 4>(
                data,
                encrypt_block_32_64,
                read_u16_le,
                write_u16_le,
            ),
            SpeckVersion::Speck48_72 => self.speck_ecb_encrypt::<u32, 3, 3>(
                data,
                encrypt_block_48_72,
                read_u24_le,
                write_u24_le,
            ),
            SpeckVersion::Speck48_96 => self.speck_ecb_encrypt::<u32, 3, 4>(
                data,
                encrypt_block_48_96,
                read_u24_le,
                write_u24_le,
            ),
            SpeckVersion::Speck64_96 => self.speck_ecb_encrypt::<u32, 4, 3>(
                data,
                encrypt_block_64_96,
                read_u32_le,
                write_u32_le,
            ),
            SpeckVersion::Speck64_128 => self.speck_ecb_encrypt::<u32, 4, 4>(
                data,
                encrypt_block_64_128,
                read_u32_le,
                write_u32_le,
            ),
            SpeckVersion::Speck96_96 => self.speck_ecb_encrypt::<u64, 6, 2>(
                data,
                encrypt_block_96_96,
                read_u48_le,
                write_u48_le,
            ),
            SpeckVersion::Speck96_144 => self.speck_ecb_encrypt::<u64, 6, 3>(
                data,
                encrypt_block_96_144,
                read_u48_le,
                write_u48_le,
            ),
            SpeckVersion::Speck128_128 => self.speck_ecb_encrypt::<u64, 8, 2>(
                data,
                encrypt_block_128_128,
                read_u64_le,
                write_u64_le,
            ),
            SpeckVersion::Speck128_192 => self.speck_ecb_encrypt::<u64, 8, 3>(
                data,
                encrypt_block_128_192,
                read_u64_le,
                write_u64_le,
            ),
            SpeckVersion::Speck128_256 => self.speck_ecb_encrypt::<u64, 8, 4>(
                data,
    ...
    pub(in crate::cipher) fn decrypt_ecb(&self, data: &[u8]) -> Result<Vec<u8>, SPECKError> {
        ...
        let out = match self.speck_version {
            SpeckVersion::Speck32_64 => self.speck_ecb_decrypt::<u16, 2, 4>(
                data,
                decrypt_block_32_64,
                read_u16_le,
                write_u16_le,
            ),
            SpeckVersion::Speck48_72 => self.speck_ecb_decrypt::<u32, 3, 3>(
                data,
                decrypt_block_48_72,
                read_u24_le,
                write_u24_le,
            ),
            SpeckVersion::Speck48_96 => self.speck_ecb_decrypt::<u32, 3, 4>(
                data,
                decrypt_block_48_96,
                read_u24_le,
                write_u24_le,
            ),
            SpeckVersion::Speck64_96 => self.speck_ecb_decrypt::<u32, 4, 3>(
                data,
                decrypt_block_64_96,
                read_u32_le,
                write_u32_le,
            ),
            SpeckVersion::Speck64_128 => self.speck_ecb_decrypt::<u32, 4, 4>(
                data,
                decrypt_block_64_128,
                read_u32_le,
                write_u32_le,
            ),
            SpeckVersion::Speck96_96 => self.speck_ecb_decrypt::<u64, 6, 2>(
                data,
                decrypt_block_96_96,
                read_u48_le,
                write_u48_le,
            ),
            SpeckVersion::Speck96_144 => self.speck_ecb_decrypt::<u64, 6, 3>(
                data,
                decrypt_block_96_144,
                read_u48_le,
                write_u48_le,
            ),
            SpeckVersion::Speck128_128 => self.speck_ecb_decrypt::<u64, 8, 2>(
                data,
                decrypt_block_128_128,
                read_u64_le,
                write_u64_le,
            ),
            SpeckVersion::Speck128_192 => self.speck_ecb_decrypt::<u64, 8, 3>(
                data,
                decrypt_block_128_192,
                read_u64_le,
                write_u64_le,
            ),
            SpeckVersion::Speck128_256 => self.speck_ecb_decrypt::<u64, 8, 4>(
                data,
