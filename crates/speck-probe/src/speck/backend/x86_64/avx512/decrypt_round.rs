macro_rules! avx512_decrypt_round_inline {
    ($x:expr, $y:expr, $k:expr, $word:tt, $alpha:expr, $beta:expr) => {
        ...
        $y = $crate::speck::backend::x86_64::avx512::avx512_ror!($word, $y, $beta);

        $x = $crate::speck::backend::x86_64::avx512::avx512_xor!($word, $x, $k);
        $x = $crate::speck::backend::x86_64::avx512::avx512_sub!($word, $x, $y);
        $x = $crate::speck::backend::x86_64::avx512::avx512_rol!($word, $x, $alpha);
    };
}
