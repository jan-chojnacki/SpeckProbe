        ...
        seq_macro::seq!(S in 1..=4 {
            paste::paste! {
                ...
                pub(crate) fn dispatch(
                    request: $crate::runtime::api::RuntimeRequest,
                    version: speck::SpeckVersion,
                    suffix: usize,
                    function: $crate::runtime::api::CipherFunction,
                ) -> $crate::runtime::api::DispatchOutput {
                    use $crate::runtime::backend::runner::run_orchestrator;
                    match (version, suffix, function) {
                        $(
                            #(
                                (speck::SpeckVersion::[<Speck $version>], S, $crate::runtime::api::CipherFunction::Encrypt) =>
                                ...
                                (speck::SpeckVersion::[<Speck $version>], S, $crate::runtime::api::CipherFunction::Decrypt) =>
                                    run_orchestrator::<$ew, $vw, $bytes, {$bytes - S}, _, _>(
                                        request,
                                ...
                                (speck::SpeckVersion::[<Speck $version>], S, $crate::runtime::api::CipherFunction::EncryptInflight) =>
                                    run_orchestrator::<$ew, $vw, $bytes, {$bytes - S}, _, _>(
                                        request,
