...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_32_64,
    inflight:  engine::sse2_search_encrypt_inflight_32_64,
    decrypt:   engine::sse2_search_decrypt_32_64,
    v:         0x0100_0908_1110_1918_u64,
    prefix:    [],
    key_bytes: &[0x18u8, 0x19, 0x10, 0x11, 0x08, 0x09, 0x00, 0x01],
    pt:        [0x6574_u16, 0x694c],
    ct:        [0xa868_u16, 0x42f2],
    converter: engine::x86_64::sse2::converter::sse2_u16x2_block_to_vec,
    word:      u16,
}

search_tests! {
    mod sse2_search_48_72,
    encrypt:   engine::sse2_search_encrypt_48_72,
    inflight:  engine::sse2_search_encrypt_inflight_48_72,
    decrypt:   engine::sse2_search_decrypt_48_72,
    ...
    converter: engine::x86_64::sse2::converter::sse2_u32x2_block_to_vec,
    word:      u32,
}

search_tests! {
    mod sse2_search_48_96,
    encrypt:   engine::sse2_search_encrypt_48_96,
    inflight:  engine::sse2_search_encrypt_inflight_48_96,
    decrypt:   engine::sse2_search_decrypt_48_96,
...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_64_96,
    inflight:  engine::sse2_search_encrypt_inflight_64_96,
    decrypt:   engine::sse2_search_decrypt_64_96,
...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_64_128,
    inflight:  engine::sse2_search_encrypt_inflight_64_128,
    decrypt:   engine::sse2_search_decrypt_64_128,
...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_96_96,
    inflight:  engine::sse2_search_encrypt_inflight_96_96,
    decrypt:   engine::sse2_search_decrypt_96_96,
    ...
    converter: engine::x86_64::sse2::converter::sse2_u64x2_block_to_vec,
    word:      u64,
}

search_tests! {
    mod sse2_search_96_144,
    encrypt:   engine::sse2_search_encrypt_96_144,
    inflight:  engine::sse2_search_encrypt_inflight_96_144,
    decrypt:   engine::sse2_search_decrypt_96_144,
...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_128_128,
    inflight:  engine::sse2_search_encrypt_inflight_128_128,
    decrypt:   engine::sse2_search_decrypt_128_128,
...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_128_192,
    inflight:  engine::sse2_search_encrypt_inflight_128_192,
    decrypt:   engine::sse2_search_decrypt_128_192,
...
search_tests! {
    ...
    encrypt:   engine::sse2_search_encrypt_128_256,
    inflight:  engine::sse2_search_encrypt_inflight_128_256,
    decrypt:   engine::sse2_search_decrypt_128_256,
