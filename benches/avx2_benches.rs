...
define_cipher_bench!(
    ...
    avx2_48_72_bench,
    prefix = "48_72",
    key = [_mm256_set1_epi32(0), _mm256_set1_epi32(0), _mm256_set1_epi32(0),],
...
define_cipher_bench!(
    ...
    avx2_96_144_bench,
    prefix = "96_144",
    key = [_mm256_set1_epi64x(0), _mm256_set1_epi64x(0), _mm256_set1_epi64x(0),],
    pt = [_mm256_set1_epi64x(0), _mm256_set1_epi64x(0)],
...
fn benchmark(c: &mut Criterion) {
    let mut g = c.benchmark_group("avx2");
