...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_32_64,
    v:         0x0100_0908_1110_1918_u64,
    prefix:    [],
    key_bytes: &[0x18u8, 0x19, 0x10, 0x11, 0x08, 0x09, 0x00, 0x01],
    pt:        [0x6574_u16, 0x694c],
    ct:        [0xa868_u16, 0x42f2],
    converter: crate::search::executor::backend::x86_64::sse2::sse2_u16x2_block_to_vec,
    word:      u16,
}
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_48_72,
    ...
    converter: crate::search::executor::backend::x86_64::sse2::sse2_u32x2_block_to_vec,
    word:      u32,
}
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_48_96,
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_64_96,
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_64_128,
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_96_96,
    ...
    converter: crate::search::executor::backend::x86_64::sse2::sse2_u64x2_block_to_vec,
    word:      u64,
}
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_96_144,
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_128_128,
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_128_192,
...
search_tests! {
    ...
    decrypt:   crate::search::executor::backend::sse2_search_decrypt_128_256,
