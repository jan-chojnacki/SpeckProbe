...
search_tests! {
    ...
    converter: crate::search::executor::backend::aarch64::neon::converter::neon_u16x2_block_to_vec,
    word:      u16,
}
...
search_tests! {
    ...
    converter: crate::search::executor::backend::aarch64::neon::converter::neon_u32x2_block_to_vec,
    word:      u32,
}
...
search_tests! {
    ...
    converter: crate::search::executor::backend::aarch64::neon::converter::neon_u64x2_block_to_vec,
    word:      u64,
}
