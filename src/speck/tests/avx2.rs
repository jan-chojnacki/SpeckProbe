...
mod test {
    ...
    use crate::speck::{
        ...
        avx2_encrypt_block_128_192, avx2_encrypt_block_128_256, avx2_encrypt_block_inflight_32_64,
        avx2_encrypt_block_inflight_48_72, avx2_encrypt_block_inflight_48_96,
        avx2_encrypt_block_inflight_64_96, avx2_encrypt_block_inflight_64_128,
        avx2_encrypt_block_inflight_96_96, avx2_encrypt_block_inflight_96_144,
        avx2_encrypt_block_inflight_128_128, avx2_encrypt_block_inflight_128_192,
        avx2_encrypt_block_inflight_128_256,
    };
    ...
    define_speck_test_x86_64_simd!(
        ...
        expected = [
            _mm256_set1_epi16(0xa868u16 as i16),
            _mm256_set1_epi16(0x42f2)
        ]
    );
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_32_64",
        avx2_encrypt_block_inflight_32_64,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_48_72",
        avx2_encrypt_block_inflight_48_72,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_48_96",
        avx2_encrypt_block_inflight_48_96,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_64_96",
        avx2_encrypt_block_inflight_64_96,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_64_128",
        avx2_encrypt_block_inflight_64_128,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_96_96",
        avx2_encrypt_block_inflight_96_96,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_96_144",
        avx2_encrypt_block_inflight_96_144,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_128_128",
        avx2_encrypt_block_inflight_128_128,
        "x86_64",
        "avx2",
        key = [
    ...
    define_speck_test_x86_64_simd!(
        "avx2_encrypt_block_inflight_128_192",
        avx2_encrypt_block_inflight_128_192,
        "x86_64",
        "avx2",
        key = [
